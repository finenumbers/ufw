...
Нажмите **Сохранить правила** (с предпросмотром плана). Приложение:
...
Если применение прервётся на полпути, удалённый UFW может отличаться и от черновика, и от снимка. Интерфейс предупреждает и предлагает **Принудительную синхронизацию с сервером**, чтобы выровнять локальное состояние по фактическим удалённым правилам перед дальнейшим редактированием.
