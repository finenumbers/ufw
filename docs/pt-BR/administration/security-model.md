...
- ICMP do container do app para os endereços fixados dos servidores gerenciados
- HTTPS do container do app para cheburcheck.ru para verificar se os hosts dos servidores gerenciados estão restritos
