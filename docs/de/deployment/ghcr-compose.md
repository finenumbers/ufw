...
Jede Release veröffentlicht **`latest`** plus Versions-Tags (z. B. `v0.8.0`, `0.6.1`). Produktions-Deploys nutzen standardmäßig **`latest`** — keine Version in `.env` erforderlich.
