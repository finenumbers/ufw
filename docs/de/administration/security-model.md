...
- ICMP vom App-Container an festgelegte Adressen der verwalteten Server
- HTTPS vom App-Container zu cheburcheck.ru, um zu prüfen, ob Hosts verwalteter Server eingeschränkt sind
